...
async function main() {
  const customers = [
    ...
    },
    {
      ...
      address: [
        { street: "789 Oak St", city: "Sometown", state: "TX", zip: "54321" },
      ],
      customerType: "INDIVIDUAL",
    ...
    },
    {
      ...
      address: [
        { street: "101 Pine St", city: "Anycity", state: "FL", zip: "67890" },
      ],
      customerType: "INDIVIDUAL",
    ...
    },
    {
      ...
      address: [
        { street: "202 Birch St", city: "Anyville", state: "WA", zip: "12345" },
      ],
      customerType: "INDIVIDUAL",
    ...
    },
    {
      ...
      address: [
        { street: "303 Cedar St", city: "Techcity", state: "CA", zip: "98765" },
      ],
    ...
    },
    {
      ...
      address: [
        { street: "404 Maple St", city: "Biztown", state: "NY", zip: "87654" },
      ],
      customerType: "COMPANY",
